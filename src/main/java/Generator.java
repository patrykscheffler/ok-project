...
public class Generator {
    ...
    public static <E> void main(String args[]) throws IOException {
        ...
        for(int inst = instanceNumber; inst < (wieViele + instanceNumber); inst++) {
	        ...
	        pw.close();
	        System.out.println("Zakonczono generowanie instancji problemu nr " + inst + " z " + tasksAmount + " zadaniami!");
        }
    }
}